            ...
            <>
              ...
              <div className="me-scroll">
                ...
                <section className="me-works">
                  ...
                  <a href="https://human-design.wonderelian.com/" target="_blank" rel="noreferrer"><b>{language === "zh" ? "二" : "02"}</b><span><strong>{language === "zh" ? "不二 认识自己" : "Not Two · Know Yourself"}</strong><em>{language === "zh" ? "人生使用说明书" : "A User Manual for Life"}</em><small>{language === "zh" ? "看见自己的能量结构，理解真实而独特的自己。" : "See your energy design and understand your authentic, individual self."}</small></span><ExternalLinkIcon /></a>
                  <a href="https://wendao.wonderelian.com" target="_blank" rel="noreferrer"><b>{language === "zh" ? "三" : "03"}</b><span><strong>{language === "zh" ? "三慢问道" : "Wendao"}</strong><em>{language === "zh" ? "道德经" : "Tao Te Ching"}</em><small>{language === "zh" ? "读懂经典，也在慢下来时读懂自己。" : "Read the classic slowly—and yourself with it."}</small></span><ExternalLinkIcon /></a>
                  <a href="https://style-atlas.wonderelian.com" target="_blank" rel="noreferrer"><b>{language === "zh" ? "四" : "04"}</b><span><strong>{language === "zh" ? "艺术风格图鉴" : "Style Atlas"}</strong><em>{language === "zh" ? "学习看懂一种美" : "Learn to see a style"}</em><small>{language === "zh" ? "沿着艺术与设计风格的脉络，找到自己的观看方式。" : "Follow art and design lineages to find your own way of looking."}</small></span><ExternalLinkIcon /></a>
                </section>
