...
test("guides hub organizes every English intent page and exposes a real preview and truthful collection schema", async () => {
  ...
  assert.match(software.downloadUrl, /id1461182261$/);
  assert.match(html, /data-audio-preview="\/assets\/yixiu\/audio\/river-flow\.m4a"/);
  for (const route of ["sleep-sounds", "focus-sounds", "rain-sounds-for-reading", "river-sounds-for-studying", "best-nature-sounds-for-studying", "ocean-waves-for-focus", "mountain-stream-sounds-for-focus", "waterfall-sounds-for-noise-masking", "one-minute-reset"]) {
