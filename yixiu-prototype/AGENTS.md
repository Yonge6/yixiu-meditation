...
- Every H5 App Store action must use Apple's region-neutral `https://apps.apple.com/app/id1461182261` path and navigate in the current window. Do not restore a fixed `/us/` storefront or `target="_blank"`; both break the direct download path inside WeChat's embedded browser for visitors in China.
