...
- 2026-09-16 11:56 CST: build 28 processing completed and selected for version 1.14; formal submission succeeded. Official receipt reads Waiting for Review for 1.14 (28), submission `e753b499-431a-4898-b991-1e258fedac40`: https://appstoreconnect.apple.com/apps/1461182261/distribution/reviewsubmissions/details/e753b499-431a-4898-b991-1e258fedac40 . Build UUID `952797d1-7039-4b57-90dc-f7d4434f0e38`.
- Existing screenshots, automatic release, immediate update rollout, rating retention, no-login setting and review notes preserved. No price changes yet. Next gate: official release approval/distributable state, then configure and verify the one-month approximately 20%-price introductory campaign. Do not withdraw or resubmit this waiting submission.
